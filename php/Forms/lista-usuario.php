...
<div class="col-md-12">
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-buscar-cliente" style="width: 100%;  " onclick="Form_Usuario()">
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            while ($row_resultado = mysqli_fetch_assoc($resultado)) {
                echo '<tr><th scope="row">' . $row_resultado['cod_usuario'] . '</th>'
                    . '<td>' . $row_resultado['nome_usuario'] . '</td>'
                    . '<td>' . $row_resultado['login_usuario'] . '</td>'
                    . '<td>' . $row_resultado['email_usuario'] . '</td>'
                    . '<td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-buscar-cliente" style="width: 100%;  " onclick="Form_Usuario()">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
                </svg>Produtos
            </button></td></tr>';
